...
function get_todos() {
    ...
    var todos = new Array;
    /*thid pulls the task that was saved in the web browser memory*/
...
function show() {
    ...
    for (var i = 0; i < todos.length; i++) {
        /*this also displays the task as a list and creates the buttom with the "x"*/
    ...
    /*this tells the browser how to display the todo array after
...
/*this displays the inputed task when the 'Add Item' button clicked*/
